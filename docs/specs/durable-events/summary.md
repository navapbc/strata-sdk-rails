# Durable events: distilled specification

> This is a concise companion to [the full design specification](./spec.md).
> It is intended for review, planning, and implementation orientation. The full
> specification remains authoritative when this summary omits detail. Decisions
> explicitly recorded as resolved here supersede earlier proposals in the full
> specification until that document is synchronized. The
> [source intent](../../intent/durable-events.md) remains authoritative when the
> design and intent disagree.
